...
![The Edge Protocols selection page](/images/edge-protocols/1.png)

*The Edge Protocols selection page*

**Important:** Edge protocol tests require a Server Configuration profile to be set up before a test can be run. See the Server Configuration document for instructions on creating and managing profiles.
